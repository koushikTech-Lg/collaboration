...
export function KnowledgeBanner() {
    ...
    return (
        ...
        //                        Judging and curating finance, business, and strategy-based rounds - case studies for events. Sharing in-depth analysis reports and articles prepared by our team of research analysts.
        //                     </motion.p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-12 gap-8 items-center text-left  sm:mt-[100px] lg:mt-0">
                    ...
                    <motion.div variants={itemVariants} className="space-y-6 ">
                        ...
                        <motion.h1 variants={itemVariants} className=" text-3xl sm:text-4xl lg:text-6xl font-bold text-white leading-tight">
                              Knowledge <span className="text-orange-500">Partnership</span>
                        </motion.h1>

                        {/* Description */}
                        <motion.p variants={itemVariants} className="lg:text-lg text-sm text-slate-200 leading-relaxed max-w-xl">
                            Judging and curating finance, business, and strategy-based rounds - case studies for events. Sharing in-depth 
                            analysis reports and articles prepared by our team of research analysts.
                        </motion.p>
