            ...
            {seminars.map((seminar) => (
              ...
              >
                <div className="flex gap-3">
                  {/* Icon */}
                  {/* <div className={`w-12 h-12 ${seminar.iconBg} rounded-lg flex items-center justify-center`}>
                    <seminar.icon className={`w-6 h-6 ${seminar.iconColor}`} />
                  </div> */}
                  {/* <div className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-br from-[#274287] to-[#1a2f5c] rounded-xl shadow-lg relative overflow-hidden group">
                    <seminar.icon className="w-8 h-8 text-white relative z-10" />
                    <div className="absolute top-1.5 left-1.5 w-2.5 h-2.5 bg-white/40 rounded-full blur-sm"></div>
                    <div className="absolute -top-0.5 -right-0.5 w-2.5 h-2.5 bg-[#F5872C] rounded-full animate-pulse"></div>
                  </div> */}
